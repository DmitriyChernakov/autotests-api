...
def assert_exercise(actual: ExerciseSchema, expected: ExerciseSchema):
    """
    Проверяет корректность данных упражнения.
...
def assert_get_exercise_response(
    ...
    """
    Проверяет, что данные упражнения при создании и запросе совпадают.

    :param get_exercise_response: Структура ответа получения упражнения с его данными.
    :param create_exercise_response: Структура ответа создания упражнения с его данными.
