...
def assert_get_user_response(get_user_response: GetUserResponseSchema, create_user_response: CreateUserResponseSchema):
    ...
    :param get_user_response: Структура ответа получения пользователя с его данными.
    :param create_user_response: Структура ответа создания пользователя с его данными.
